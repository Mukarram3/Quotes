    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1 class="text-center text-white">Bodybuilduing</h1>
            ...
            $query1= " SELECT * FROM `imagesquotes` WHERE `catId`=2 AND `status`='approved' ";
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `textquotes` WHERE `catId`=2 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
...
<div class='product'>
                                        ...
                                        <div class='product-body'>
                                            ...
                                            <div class='product-btns'>
                                                ...
                                                <input type="hidden" value="<?php echo $row1["auther"]; ?>"
                                                    name="auther_text">
                                                <button class='' <?php if(!isset($_SESSION["login_user"])){
														echo 'type="button" data-toggle="modal" data-target="#Modal_login"';
													}else {
														echo 'type="submit"';
													} ?> name="fav_text"><i class='fa fa-heart-o'></i><span
                                                        class='tooltipp'>add to wishlist</span></button>
                                                <button class='add-to-compare'><i class='fa fa-exchange'></i><span
                                                        class='tooltipp'>add to compare</span></button>
                                                <button class='quick-view'><i class='fa fa-eye'></i><span
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `videoquotes` WHERE `catId`=2 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
