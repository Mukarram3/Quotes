...
if(isset($_GET['action']) && $_GET['action']!="" && $_GET['action']=='edit'){
    ...
    $query2= "SELECT * FROM `imagesquotes` WHERE `id`='$id' ";
...
$query= "UPDATE `imagesquotes` SET `catId`='$cat_id',`auther`='$author',`imgUrl`='$image',`category`='$cat_name' WHERE `id`='$id'  ";
...
?>
      ...
      <div class="content">
        ...
        <h1 class="text-center text-white">Update Image Quote</h1>
         ...
         <div class="col-md-9">
            <div class="card">
              <div class="card-header card-header-primary">
                <h5 class="title">Update Image Quote</h5>
              </div>
              <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="<?php echo $row2["id"]; ?>">
                    ...
                    <div class="col-md-4">
                      <div class="">
                        ...
                        <input type="file" name="image" value="<?php echo $row2["imgUrl"]; ?>" required class="btn btn-fill btn-success" id="picture" >
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
