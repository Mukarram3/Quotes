            ...
            if(mysqli_num_rows($res1)>0){
               ...
               while($row1=mysqli_fetch_array($res1)){
                ...
                <div class="col-md-4 col-xs-6">
                    <a href="<?php echo $row1["imgUrl"]; ?>">
                        <div class="shop">
                            <div class="shop-img">
                                <img src="<?php echo $row1["imgUrl"]; ?>" alt="loading">
                            </div>
                            <div class="shop-body">
                                <h3><?php echo $row1["title"]; ?></h3>
                                <a href="<?php echo $row1["page-url"]; ?>" class="cta-btn">Shop now <i
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `imagesquotes` WHERE `status`='Approved' ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
                                            ...
                                            <div class='product-body'>
                                                ...
                                                <div class='product-btns'>
                                                    ...
                                                    <button  <?php if(!isset($_SESSION["login_user"])){
														...
														echo 'type="submit"';
													} ?> class='add-to-wishlist btn-success'><i class='fa fa-heart-o'></i><span class='tooltipp'>add to
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `textquotes` WHERE `status`='Approved' ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `videoquotes` WHERE `status`='Approved' ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
