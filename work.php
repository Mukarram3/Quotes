    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1 class="text-center text-white"> Work Category</h1>
            ...
            $query1= " SELECT * FROM `imagesquotes` WHERE `catId`=4 ";
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `textquotes` WHERE `catId`=4 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `videoquotes` WHERE `catId`=4 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
