    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1 class="text-center text-white"> Positive thinking Category</h1>
            ...
            $query1= " SELECT * FROM `imagesquotes` WHERE `catId`=5 ";
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `textquotes` WHERE `catId`=5 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
...
?>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            $query1= " SELECT * FROM `videoquotes` WHERE `catId`=5 ";
            $res1= mysqli_query($con,$query1);
            if(mysqli_num_rows($res1)>0){
